...
class PaymentControllerTest {
    ...
    void recordPayment_withValidRequest_shouldReturn201() throws Exception {
        ...
        when(paymentService.recordPayment(eq("1114"), any(), any(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull()))
    ...
    void recordPayment_whenMemberNotFound_shouldReturn404() throws Exception {
        when(paymentService.recordPayment(eq("9999"), any(), any(), isNull(), isNull(), isNull(), isNull(), isNull(), isNull()))
